...
#define stepper_timer_wrap 5
#define stepper_timer_pio_version 0
...
static const struct pio_program stepper_timer_program = {
    ...
    .length = 6,
    .origin = -1,
    .pio_version = stepper_timer_pio_version,
...
static inline void stepper_timer_set_period(PIO pio, uint32_t sm, uint32_t offset, uint32_t period, uint32_t adj) {
...
#define step_pulse_pio_version 0
...
static const struct pio_program step_pulse_program = {
    ...
    .length = 7,
    .origin = -1,
    .pio_version = step_pulse_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
#define step_dir_sr4_pio_version 0
...
static const struct pio_program step_dir_sr4_program = {
    ...
    .length = 20,
    .origin = -1,
    .pio_version = step_dir_sr4_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
static const struct pio_program sr_delay_program = {
    ...
    .length = 6,
    .origin = -1,
    .pio_version = sr_delay_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
static const struct pio_program sr_hold_program = {
    ...
    .length = 6,
    .origin = -1,
    .pio_version = sr_hold_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
...
static const struct pio_program out_sr16_program = {
    ...
    .length = 5,
    .origin = -1,
    .pio_version = out_sr16_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};
