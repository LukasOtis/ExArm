/*
  ...
  NOTE: PIO step generator requires consecutive pins; our layout uses non-consecutive
  step pins. We therefore use GPIO_OUTPUT for steps and define pins explicitly.
*/
...
#if RP_MCU != 2350
#error "This board map targets RP2350 processors (Pico 2)."
#endif

#define BOARD_NAME "ExArm Pico2Breakout"
